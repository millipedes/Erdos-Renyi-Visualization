...
int main(void) {
  ...
  node the_node = init_node("t1", init_pixel(0, 190, 255), 300, 300, 150);
  node the_node1 = init_node("t2", init_pixel(0, 190, 255), 500, 500, 75);
  node the_node2 = init_node("t3", init_pixel(0, 190, 255), 300, 950, 100);
